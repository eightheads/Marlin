...
#define STRING_CONFIG_H_AUTHOR "(Trevor, SKR Turbo MMU2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MMU2 Bugfix"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -2.50 }
...
#define Z_PROBE_SPEED_FAST (240 * 2)
