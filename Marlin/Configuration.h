...
#define STRING_CONFIG_H_AUTHOR "(Trevor, SKR E3 Turbo SV01)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SV01 E3 Turbo"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 75 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -5, -0.6 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + 10))  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + 10))  // Y point for Z homing
#endif
