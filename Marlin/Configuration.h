...
#define STRING_CONFIG_H_AUTHOR "(Trevor, Eryone ER-20 Bugfix)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ER20 Bugfix"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -2.61 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 8)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 8)  // Y point for Z homing
#endif
